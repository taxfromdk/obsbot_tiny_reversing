...
# cmd: /usr/local/bin/usbrply --device-hi --sleep --wrapper --comment --setup -p captures/reset.pcapng
...
def replay(dev):
    ...
    # PcapGen: generated 17 packets
    # PcapGen device filter: dropped 0 / 17 packets
