...
# cmd: /usr/local/bin/usbrply --device-hi --sleep --wrapper --comment --setup -p captures/idle.pcapng
...
def replay(dev):
    ...
    # PcapGen: generated 13 packets
    # PcapGen device filter: dropped 0 / 13 packets
