...
# cmd: /usr/local/bin/usbrply --device-hi --sleep --wrapper --comment --setup -p captures/manipulatefromoutside.pcapng
...
def replay(dev):
    ...
    # PcapGen: generated 21 packets
    # PcapGen device filter: dropped 0 / 21 packets
